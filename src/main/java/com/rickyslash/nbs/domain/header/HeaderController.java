package com.rickyslash.nbs.domain.header;

import com.rickyslash.nbs.domain.header.services.GetProductWithHeaderSvc;
import com.rickyslash.nbs.domain.header.services.GetRegionHeaderResponseSvc;
